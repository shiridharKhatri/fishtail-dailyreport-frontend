    ...
    <div className="dark fixed inset-0 z-50 bg-background flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center gap-8 px-4">
        ...
        <div className="text-center space-y-3 max-w-sm">
          <h2 className="text-lg font-medium text-foreground tracking-wide">Signing out</h2>
          <p className="text-xs text-muted-foreground tracking-wide opacity-80 font-light">Securing your session</p>
        </div>
